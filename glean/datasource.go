...
func RegisterDatasource(ctx context.Context, sdk *apiclientgo.Glean, dsName, displayName, netboxURL string, crawlers map[string]crawler.Crawler) error {
	...
	dsConfig := components.CustomDatasourceConfig{
		...
		IconURL:             crawler.Ptr("https://raw.githubusercontent.com/nexthop-ai/netbox-glean-datasource/master/logo/netbox-logo_light_theme.svg"),
		IconDarkURL:         crawler.Ptr("https://raw.githubusercontent.com/nexthop-ai/netbox-glean-datasource/master/logo/netbox-logo_dark_theme.svg"),

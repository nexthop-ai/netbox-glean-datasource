...
func (d *DeviceCrawler) ObjectDefinition() components.ObjectDefinition {
	return components.ObjectDefinition{
		...
		PropertyDefinitions: []components.PropertyDefinition{
			...
			PropertyDef("nbDeviceType", "Device Type", components.PropertyDefinitionPropertyTypeText),
			PropertyDef("nbPlatform", "Platform", components.PropertyDefinitionPropertyTypeText),
			PropertyDef("nbRack", "Rack", components.PropertyDefinitionPropertyTypeText),
			PropertyDef("nbSerialNumber", "Serial Number", components.PropertyDefinitionPropertyTypeText),
			PropertyDef("nbAssetTag", "Asset Tag", components.PropertyDefinitionPropertyTypeText),

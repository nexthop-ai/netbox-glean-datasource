...
func (c *VMCrawler) ObjectDefinition() components.ObjectDefinition {
	return components.ObjectDefinition{
		...
		PropertyDefinitions: []components.PropertyDefinition{
			...
			FacetDef("nbCluster", "Cluster", components.PropertyDefinitionPropertyTypePicklist, 2),
			FacetDef("nbSite", "Site", components.PropertyDefinitionPropertyTypePicklist, 3),
			FacetDef("nbRole", "Role", components.PropertyDefinitionPropertyTypePicklist, 4),
			PropertyDef("nbTenant", "Tenant", components.PropertyDefinitionPropertyTypeText),
			PropertyDef("nbPlatform", "Platform", components.PropertyDefinitionPropertyTypeText),
			PropertyDef("nbVcpus", "vCPUs", components.PropertyDefinitionPropertyTypeText),
			PropertyDef("nbMemory", "Memory (MB)", components.PropertyDefinitionPropertyTypeText),
			PropertyDef("nbDisk", "Disk (GB)", components.PropertyDefinitionPropertyTypeText),
			PropertyDef("nbPrimaryIP", "Primary IP", components.PropertyDefinitionPropertyTypeText),
		},
	}
}

...
func (c *InterfaceCrawler) ObjectDefinition() components.ObjectDefinition {
	return components.ObjectDefinition{
		...
		PropertyDefinitions: []components.PropertyDefinition{
			...
			FacetDef("nbInterfaceType", "Type", components.PropertyDefinitionPropertyTypePicklist, 2),
			PropertyDef("nbSpeed", "Speed", components.PropertyDefinitionPropertyTypeText),
			PropertyDef("nbMtu", "MTU", components.PropertyDefinitionPropertyTypeText),
			PropertyDef("nbMode", "Mode", components.PropertyDefinitionPropertyTypeText),
			PropertyDef("nbMacAddress", "MAC Address", components.PropertyDefinitionPropertyTypeText),
			PropertyDef("nbEnabled", "Enabled", components.PropertyDefinitionPropertyTypeText),
			PropertyDef("nbConnectedTo", "Connected To", components.PropertyDefinitionPropertyTypeText),
			PropertyDef("nbLag", "LAG", components.PropertyDefinitionPropertyTypeText),
			PropertyDef("nbUntaggedVlan", "Untagged VLAN", components.PropertyDefinitionPropertyTypeText),
			PropertyDef("nbTaggedVlans", "Tagged VLANs", components.PropertyDefinitionPropertyTypeText),
		},
	}
}
